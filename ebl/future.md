...
# Introduction
These are the features I want to develop later
...
- During the auction, it would be nice to have a list of available players that haven't been auctioned off yet so that we can see who's available.
- Provide a 1-man disabled list for each team.