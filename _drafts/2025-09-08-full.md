...
I tried the two central weights in the sorted list as w1 and w2 with similar results. Some matches to the protein table, but with incorrect proteins and not all the correct proteins.
